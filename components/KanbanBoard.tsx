    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-4 flex-wrap">
        <div className="relative flex-1 max-w-sm">
          <Search className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: "var(--ink-faint)" }} />
          <input
            value={search}
            onChange={e => setSearch(e.target.value)}
            placeholder="Search company or role…"
            className="input-field"
            style={{ background: "transparent", paddingLeft: "3.5rem", paddingRight: "2.25rem" }}
          />
          {search && (
