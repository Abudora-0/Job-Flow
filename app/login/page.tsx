      ...
      <div className="relative z-10 w-full max-w-md px-6 animate-fade-in-up">
        ...
        <div className="glass rounded-2xl p-8 space-y-6">
          <div className="text-center">
            ...
            <p className="text-gray-400 text-sm mt-2">Organize applications with a beautiful Kanban board</p>
          </div>
          ...
          <p className="text-gray-500 text-xs text-center">Free forever. No credit card required.</p>
        </div>
      </div>
    </div>
  );
